    ...
    navigator.getBattery().then((batt) => {
        updateBattery = () => {
            ...
            if (level == 100) {
                ...
                batteryStatus.innerHTML = `Low <i class="ri-plug-line animated-red animated-red"></i>`;
            } else if (batt.charging) {
                batteryStatus.innerHTML = `On Charging ... <i class="ri-flashlight-line animated-green"></i>`;
            } else {
